...
if(isset($_POST['valider'])) {
    ...
    $stmt->execute(array(':nom_client'=> $nom_client, ':prenom_client' => $prenom_client, ':civilite_client' => $civilite_client, ':adresse_client' => $adresse_client, ':cp_client' => $cp_client, ':ville_client' => $ville_client, ':tel_client' => $tel_client, ':mail_client' => $mail_client, ':pseudo_client' => $pseudo_client, ':password_client' => $hash));
}
?>
