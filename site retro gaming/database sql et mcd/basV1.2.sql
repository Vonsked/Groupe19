...
-- Généré le :  Mar 13 Décembre 2016 à 18:09
...
(1, 'NES', 'Sortie en France en 1987, La NES est l''adaptation de la Famicom japonaise. Console 8-bit avec cartouche, elle permet alors de redonner une dynamique à l''industrie du jeu vidéo. La con-sole voit également naître les premiers épisodes de séries mythiques comme Mario et Zelda qui contribuent grandement à son succès. Elle devient en 1990 la console la plus populaire de l''histoire du jeu vidéo.\r\n', '60.000', 4, 'NES_2.jpg', 1, 1),
...
(3, 'Game boy GB/GBC', 'C''est Gunpei Yokoi, employé de Nintendo, qui créa cette console à la puissance comparable à celle de la NES (Famicom au Japon) mais avec un écran monochrome, ceci afin de pouvoir vendre la console à bas prix.\r\nCette console reprend le principe de la ma-chine Microvision de 1979, conçue par Jay Smith, une machine portable avec un écran de pixels (contrairement aux Game and Watch de Gunpei Yokoi, qui utilisaient des dessins prédéfinis), et des cartouches pour les différents jeux (pas de cartouches pour les Game and Watch).\r\n', '29.000', 10, 'Game_Boy_Color-2.jpg', 1, 1),
(4, 'Game boy advance', 'La Game Boy Advance sort le 22 Juin 2001 en France. Pour la petite anecdote, nous devons l’originalité de cette console à un designer français, Gwenaël Nicolas, qui lui a donné une apparence de tête de panda en travaillant notamment sur les courbes de l’objet : Nin-tendo était en recherche d’un design surprenant et novateur. A sa sortie, son processeur 32 bits l’a hissée au rang de la console portable la plus performante! \r\nPour ne rien gâcher, son autonomie est excellente : elle tient jusqu’à 10h! Elle est l’une des consoles les plus prisées par les retro ga-mers car on y retrouve les grands classiques de la Super Nes. Après 7 ans de vie, la Game Boy Advance passe le flambeau à la Nintendo DS en 2005.\r\n', '69.000', 8, 'Game_Boy_Advance-2.jpg', 1, 1),
(5, 'Nintendo 64', 'C''est en 1996 que sort en France la Nintendo 64. La console est en fait la ré-ponse de Nintendo face à la Saturn de Sega et au succès colossale de la Playstation. Sortie bien longtemps après ses deux concurrentes, la console ne mise plus sur le 32-bit pour rivaliser mais bien 64-bit. En plus de l''absence de temps de chargement, la console comporte des titres de réfé-rence comme Goldeneye ou encore Super Mario 64, qui porte la mascotte pour la première fois en 3D dans un épisode devenu culte.\r\n', '199.000', 3, 'nintendo_64.jpg', 1, 1),
(6, 'Gamecube', 'C''est en 2002 que sort en France la Nintendo Gamecube. Célèbre pour son de-sign compact en forme de cube, la console, très attendue, rivalise dès sa sortie avec la Playstation 2 de Sony et la Xbox de Microsoft. Avec de nombreux titres exclusifs comme Rogue Squadron, Zelda ou encore Resident Evil, la Gamecube se dote rapidement d''un catalogue de qualité grâce à des adaptations plus réussies les unes que les autres. A l''époque, la console semble avoir un ni-veau jamais atteint en termes de graphismes, à tel point que nombre de joueurs se font surprendre en confondant le gameplay avec les cinématiques des jeux.\r\n', '89.000', 8, 'gamecube2-.jpg', 1, 1),
...
(10, 'Saturn', 'La Sega Saturn débarque sur le marché européen en juillet 1995 avec 5 jeux. Parmi eux, Virtua Fighter, le premier jeu de combat en 3D à investir les consoles de salon. En concur-rence directe avec la première Playstation, la Sega Saturn se distingue par la qualité de son rendu sonore et sa gestion de la 2D. Elle a aussi de bonnes capacités côté 3D. La Playstation offre déjà une vingtaine de jeux à son lancement, seulement un mois après la date de sortie de la Sega Sat-urn...C’est en 1997 que prendra fin le duel entre les deux consoles avec le lancement par Sony du remarquable Final Fantasy VII sur Playstation. Sony aura sa revanche avec la célèbre Dreamcast dès 1999.\r\n', '59.000', 4, 'Sega-Saturn.png', 1, 2),
(11, 'Dreamcast', 'Après avoir essuyé quelques plâtres avec la Saturn, Sega sort sa Dreamcast en Europe le 14 octobre 1999. Elle équipée d’un modem assez puissant pour offrir aux joueurs la pos-sibilité de naviguer sur internet et, plus important encore, de jouer en réseau. Malheureusement, le nombre de jeux dont le gameplay est élaboré en prenant en compte cette technologie est à l’époque très restreint ; il est cependant indéniable que Sega a ouvert le chemin aux jeux de rôles en ligne et a considérablement contribué à l’évolution du paysage du jeu vidéo. Les amateurs sa-luent la qualité de la Dreamcast dont le prix d’acquisition était trois fois moins élevé que celui de la Playstation 2.\r\n', '69.000', 6, 'Sega-Dreamcast.jpg', 1, 2),
(12, 'Game gear', 'Conçue pour concurrencer la Game Boy, la Sega Game Gear arrive sur le mar-ché français en juin 1991. D’un point de vue marketing, la firme Sega se montre offensive avec le slogan "Si vous jouez encore sur Game Boy, il est temps de grandir !".\r\n\r\nSouvent décrite comme une Master System portable, elle était compatible avec les jeux de sa grande sœur grâce à un adaptateur. Ses acquéreurs avaient donc un large choix en matière de jeux. Malgré cet avan-tage considérable, son principal atout se situe ailleurs : elle dispose d’un écran couleur, au contraire de la Game Boy.\r\n', '90.000', 9, 'gamegear.png', 1, 2),
...
(14, 'Playstation 2', 'Sortie en 2000, la Playstation 2 est avec 150 millions d''exemplaires la console la plus vendue de l''histoire du jeu vidéo. un succès qui portera malheureusement un coup fatal à SEGA sur le marché des consoles, dont la Dreamcast sortait quelques mois avant. Le lecteur DVD de la Playstation 2 n''y aura sans doute pas été pour rien.\r\nLa PlayStation 2 abrégé officiellement PS2 est une console de jeux vidéo de sixième génération commercialisée par Sony Computer En-tertainment, filiale de Sony. Elle est sortie le 4 mars 2000 au Japon, le 26 octobre 2000 en Amé-rique du Nord et le 24 novembre 2000 en Europe.', '30.000', 5, 'PlayStation2.png', 1, 4),
(15, 'Atari 2600', 'commercialisée en France de 1981 à 1991.\r\nElle fut la seconde console de sa-lon à sortir en France, après la Vidéopac de Philipps; Quelques hits qui firent son succès comme Space Invader, Pac-Man, Adventure…\r\n', '150.000', 3, 'atari2600.jpg', 1, 3),
...
(17, 'Atari lynx', 'L''Atari Lynx fut la seule console portable d''Atari et la première portable avec un écran LCD couleur. Elle sortit en 1989, la même année que la Game Boy (monochrome) de Nin-tendo.\r\n', '60.000', 10, 'atarilynx.jpg', 1, 3),
(18, 'Xbox', 'Sortie en 2001 aux Etats-unis et en 2002 en Europe, la Xbox marque l''avènement d''un nouvel acteur incontournable du jeu vidéo : Microsoft. La console Xbox est malgré la domina-tion de Sony un grand succès avec 24 millions de consoles à travers le monde. Elle est équipée d''un véritable système d''exploitation, d''un disque dur ainsi que d''une carte réseau ethernet qui avec le service Xbox live offrait la capacité de jouer en ligne.\r\n', '49.000', 17, 'xbox.png', 1, 5);
