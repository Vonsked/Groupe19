...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 15, 2016 at 07:36 PM
...
INSERT INTO `administrateur` (`id_admin`, `pseudo_admin`, `password_admin`) VALUES
(1, 'root', 'root');
...
INSERT INTO `client` (`id_client`, `nom_client`, `prenom_client`, `civilite_client`, `adresse_client`, `cp_client`, `ville_client`, `tel_client`, `mail_client`, `pseudo_client`, `password_client`) VALUES
(1, 'Le Scouarnec', 'Yann', 'Mr', '3 rue des lilas', '75000', 'Paris', '0614853497', 'yannlescouarnec@gmail.com', 'bunkermaster', 'Godwin'),
(2, 'Dujardin', 'Jean', 'Mr', '58 Boulevard Richelieux', '54000', 'Bordeaux', '0614325898', 'jeanduj@gmail.com', 'jeanduj', '9@-dA2'),
(3, 'Chazal', 'Claire', 'Mme', '14 rue Dubuisson', '47000', 'Nantes', '0652348497', 'claircha@gmail.com', 'claircha', 'Q73n-A'),
(4, 'Pitt', 'Brad', 'Mr', '53 Avenue Troie', '71000', 'Troyes', '0625987534', 'bradpitt@gmail.com', 'bradpitt', 'R-3nZ6'),
(5, 'Freeman', 'Gordon', 'mr', '74 rue des Paquerettes', '14000', 'Strasbourg', '0613249758', 'gorfre@gmail.com', 'gorfree', 'D4Q-s9');
...
INSERT INTO `sous_categorie` (`id_scategorie`, `nom_scategorie`) VALUES
(1, 'console'),
(2, 'jeu');
...
--
ALTER TABLE `sous_categorie`
  MODIFY `id_scategorie` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
